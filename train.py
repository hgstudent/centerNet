...
for epoch in range(epochs):
  ...
  for voc_example in voc_train.map(preprocess_img).padded_batch(batch_size,  padded_shapes=shapes, padding_values=p_values): 
  ...
  print("Total loss: "  + str(loss_cmp/(batch_size*i))
  print()
